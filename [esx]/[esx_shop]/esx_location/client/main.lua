...
function OpenVehicleMenu() -- Menu location véhicules
    ...
    local elements = {
                {label = 'Punto       500', value = 'panto', price = 500},
		{label = 'Faggio      500', value = 'faggio2', price = 500},
		{label = 'Blista     1000', value = 'blista', price = 1000},
		{label = 'Rhapsody   1000', value = 'rhapsody', price = 1000},
		{label = 'Kalahari   1000', value = 'kalahari', price = 1000}
    }
