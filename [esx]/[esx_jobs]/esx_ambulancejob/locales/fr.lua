Locales['fr'] = {
  ...
  ['heal_inprogress'] = 'vous guérissez!',
  ...
  -- Death
  ['please_wait'] = 'vous vous viderez de votre sang dans ~b~%s minutes %s seconds~s~\n',
  ['press_respawn'] = 'appuyer [~b~E~w~] pour respawn.',
  ['respawn_now_fine'] = 'respawn maintenant pour ~g~$%s ~w~[Press ~b~E~w~]',
  ['respawn_fine'] = 'tu as payé ~r~$%s~s~ to respawn.',
