...
function OpenPersonnelMenu()
	...
	ESX.TriggerServerCallback('NB:getUsergroup', function(group)
		...
		table.insert(elements, {label = 'Mes papiers',			value = 'id_card_menu'})
				...
				if data.current.value == 'menuperso_gpsrapide' then
					ESX.UI.Menu.Open(
						...
						function(data2, menu2)
							...
							if data.current.value == 'id_card_menu' then
				
				    ESX.UI.Menu.Open(
                            'default', GetCurrentResourceName(), 'id_card_menu',
                            {
                                title    = 'Menu d\'identité',
                                elements = {
                                
								{label = 'regarder sa carte d\'idendité', value = 'checkID'},
                                {label = 'Montrer sa carte d\'identité', value = 'showID'},
                                {label = 'regarder son permis', value = 'checkDriver'},
                                {label = 'Montrer son permis', value = 'showDriver'},
                                {label = 'regarder sa licences d\'armes', value = 'checkFirearms'},
                                {label = 'Montrer sa licence d\'armes', value = 'showFirearms'},
                            }
                        },
                                ...
                                ESX.ShowNotification('Aucun joueurs proximité')
                                end
