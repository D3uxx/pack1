...
-- - - - - - - - - - - - - - - - - - - - - - -
lang = 'eng'								-- English (eng) or French (fr). You can add a new language using the template below. Pay attention to commas.
...
globalConf = {
	...
	['MAIN'] = {
		...
		autoUpdate_timer = 600000,			-- Set the time interval between two updates in the DB. Useless if the previous parameter is set to false. (600000ms = 600s = 10mn) - 6000ms minimum.
